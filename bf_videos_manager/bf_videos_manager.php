...
wp_enqueue_style( 'bf_front_css_videos_manager', $style_url_videos_manager);
		...
		class bf_videos_manager {
				...
				private function create_custom_post_type_extra_fields()
				{
					...
					$this->customfields->bf_videos_manager_video_link->title = '<b>1. YT VIDEO LINK :: Enter the YT Video Link:</b><br>';												
					...
					$this->customfields->bf_videos_manager_video_id->title = '<b>2. YT VIDEO ID :: Enter ONLY the YT Video ID:</b><br>';												
					...
					$this->customfields->bf_videos_manager_video_link_to_content->title = '<b>3. WP POST ID :: Enter ONLY the WP post ID or the WP page ID:</b><br>';
					...
					$this->customfields->bf_videos_manager_video_link_to_amazon->title = '<b>4. AMAZON URL :: Enter the full Amazon URL or the shortlink:</b><br>';
					...
					$this->customfields->bf_videos_manager_video_title_link_to_amazon = new stdClass;
					$this->customfields->bf_videos_manager_video_title_link_to_amazon->type = 'text';
					$this->customfields->bf_videos_manager_video_title_link_to_amazon->title = '<b>5. AMAZON TITLE :: Enter the full Amazon URL or the shortlink:</b><br>';
					$this->customfields->bf_videos_manager_video_title_link_to_amazon->description = 'Please enter the Amazon URL like below or leave it empty! <br><code><b>Defining a testing automation strategy for a P.O with CODECEPTION_ & WordPress</b></code>';
					...
					$this->customfields->bf_videos_manager_video_link_to_github->title = '<b>6. GITHUB URL :: Enter the full Github URL:</b><br>';
					...
					$this->customfields->bf_videos_manager_video_title_link_to_github = new stdClass;
					$this->customfields->bf_videos_manager_video_title_link_to_github->type = 'text';
					$this->customfields->bf_videos_manager_video_title_link_to_github->title = '<b>7. GITHUB TITLE ::  Enter the title for the Github Repository:</b><br>';
					$this->customfields->bf_videos_manager_video_title_link_to_github->description = 'Please enter the title for the Github Repository or leave it empty!<br><code><b>Book #1: The good and small "Zambian" guide for WordPress. How to run a News Website with WordPress?</b></code>';
					...
					$this->customfields->bf_videos_manager_video_link_to_youtube_channel->title = '<b>8. YT CHANEL URL :: Enter the full Youtube Channel URL.</b><br>';
					...
					$this->customfields->bf_videos_manager_video_title_link_to_youtube_channel = new stdClass;
					$this->customfields->bf_videos_manager_video_title_link_to_youtube_channel->type = 'text';
					$this->customfields->bf_videos_manager_video_title_link_to_youtube_channel->title = '<b>8. YT CHANEL TITLE :: Enter the full Youtube Channel Title:</b><br>';
					$this->customfields->bf_videos_manager_video_title_link_to_youtube_channel->description = 'Please enter the Youtube Channel TITLE or the shortlink like below or leave it empty! <br><code><b>Defining a testing automation strategy for a P.O. with CODECEPTION_ & WordPress</b></code>';
